...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "381", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-381/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response posttest(String body) {
   classes.User1 payloadbodyObject = new classes().new User1();
   try { 
    ...
    if(res_condition) {
      JSONObject res = new classes().new User1().toJSON();
